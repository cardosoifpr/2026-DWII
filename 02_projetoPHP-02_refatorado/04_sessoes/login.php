...
// Credenciais que serão validadas
...
if (time() < $_SESSION['bloqueado_ate']) {
    ...
    $erro = "Muitas tentativas. Tente novamente em {$tempo_restante} segundos.";
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && time() >= $_SESSION['bloqueado_ate']) {
    ...
    if ($login === $USUARIO_VALIDO && $senha === $SENHA_VALIDA) {
        ...
        if ($_SESSION['tentativas'] >= 3) {
            ...
            $erro = 'Muitas tentativas. Tente novamente em 60 segundos.';
        } else {
            $restantes = 3 - $_SESSION['tentativas'];
            $erro = "Usuário ou senha incorretos. Tentativas restantes: {$restantes}.";
        }
    }
}
...
<div class="container" style="max-width: 420px;">
    <div class="form-container">
        ...
        <p style="text-align: center; margin-top: 20px; font-size: 13px; color: #6b7280;">
            <a href="../index.php" style="color: #250000;">Voltar ao início</a>
        </p>
    </div>
</div>
