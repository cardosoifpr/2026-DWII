...
<form action="editar.php?id=<?php echo $id; ?>" method="post" class="formulario">
    ...
    <div class="campo">
        <label class="label-campo">Link GitHub</label>
        <input type="text" name="link_github" class="input-texto"
    ...
    <div class="campo">
        ...
        <input type="number" name="ano" class="input-texto"
               value="<?php echo (int) $projeto['ano']; ?>" min="2000" max="2099">
    </div>
